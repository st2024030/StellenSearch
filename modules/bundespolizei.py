...
class BundespolizeiModule(BaseModule):
    ...
    def fetch_jobs(self):
        # Wir nutzen die Basis-URL, falls keine spezifische Filter-URL konfiguriert ist
        url = os.getenv("BUNDESPOLIZEI_SEARCH_URL", "https://www.komm-zur-bundespolizei.de/verstaerkung/stellenmarkt")
        ...
        job_items = soup.select('a.blockline')
